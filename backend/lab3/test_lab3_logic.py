...
class TestRC5Algorithm(unittest.TestCase):
    ...
    def test_block_symmetry_w16(self):
        pass_phrase = "test"
        w, r, b = 16, 12, 16
        S = _key_expansion(pass_phrase, w, r, b)
    ...
    def test_file_encryption_decryption_b8(self):
        ...
        w, r, b = 32, 12, 8
        data = b"Hello, World!"
        enc = encrypt_file_data(data, w, r, b, pass_phrase)
        dec = decrypt_file_data(enc, w, r, b, pass_phrase)
        self.assertEqual(data, dec)

    def test_file_encryption_decryption_b32(self):
        pass_phrase = "long_password"
        w, r, b = 32, 12, 32
